---
title: DC motor
description: My Lorenz force-based DC motor for EIR 221 at the University of
             Pretoria.
---
...
<Image alt='The motor has two yellow 3D-printed magnet holders. Magnet wire is
            wound around a 3D-printed rotor. The axle is a wooden dowel stick,
            and his held up by two 3D-printed holders, one of which is black
            instead of yellow. The holders are screwed into a poorly cut piece
            of hardboard, with some text on it written in markers (used during
            the assessment). Paperclips are used as brushes and are screwed in
            and their angles are retained using masking tape. There is also
            masking tape wrapped around the axle at two points.'
       img={require('./dc-motor-2.jpg')} />
...
<Image alt='The windings get very close to the magnets. They follow a curved
            contour instead of a square/rectangular one, ensuring minimum
            distance even as the rotor rotates.'
       img={require('./winding-distance.jpg')} />
...
<Image alt='A very simple, solid rectangular piece with a hole for the axle and
            lips to prevent the windings from falling off.'
       img={require('./cad-v1.png')} />
...
<Image alt='A much more complicated part, see below.'
       img={require('./cad-v2.png')} />
...
<Image alt='A zoomed-in view of the commutator.'
       img={require('./commutator.jpg')} />
...
<Image img={require('./speed-sensor.jpg')} />
